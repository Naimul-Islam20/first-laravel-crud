  ...
  <div class="container my-10 mx-auto">
    ...
    <form action="{{ route('store') }}" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <input type="file" id="image" name="image" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('image') }}" >
        @error('image')
          <div class="text-red-500 mt-2">{{ $message }}</div>
        @enderror
      </div>
